...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYnJuZG1lZGVpcm9zIiwiYSI6ImNrZHQ0cWhwOTB1cm0ydG55NW5rNm50a3UifQ.qB4LbngnItMwCtkh6UhkSA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/brndmedeiros/ckdt5f45l0y5t19t4xx7t61am',
    scrollZoom: false //   center: [-118.1381459, 34.0798508],
    //   zoom: 10,
    //   interactive: false,
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            // if (res.data.status === 'success') location.reload(true); // force a reload from the server and not from browser cache
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            url = type === 'password' ? "".concat(apiUrl, "/updateMyPassword") : "".concat(apiUrl, "/updateMe");
            console.log(url);
            _context.next = 6;
            return (0, _axios.default)({
              method: 'PATCH',
...
var stripe = Stripe('pk_test_51HIIbmLbTBETpJ9zblFM3knYNVwYlRCozaqax0VBnceCllVsqWtwiCWFroKRCgfQMUV9SSOsaSwkydgYlpAFwuhl00j0WqTR5U');
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    e.preventDefault(); // We are recreating the multi-part form data

    var form = new FormData();
    form.append('name', document.getElementById('name').value);
    form.append('email', document.getElementById('email').value);
    form.append('photo', document.getElementById('photo').files[0]); // files will retrieve an array and we should select the first one
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              passwordConfirm = document.getElementById('password-confirm').value; // Await here to wait until the promise is finished so after that we can do some other stuff
